...
shinyUI(navbarPage(fluidPage("United States Homelessness"), theme = shinythemes::shinytheme("cosmo"),
                   tabPanel("Overview",
                   ...
                   tabPanel("Documentation",
                            mainPanel( 
                              ...
                              h3("What is the data?"),
                              p("All the data sets we worked with can be found at",
                                #Linked Library Documentation
                                tags$a(href = "http://shiny.rstudio.com/", "Kaggle"), "and at",
                              ...
                              br(),
                              h3("Why do we care?"),
                              p("This data teaches users about the homeless prevalence (prevalence by state) and visualizes the break down the amount of homeless individuals that either have or do not have access to homeless shelters.  
